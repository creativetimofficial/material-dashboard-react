    ...
    render(){
        return (
            <div>
                ...
                <P>You will find all the variables regarding the charts in <code>src/variables/charts.jsx</code>, all the styles variables (we will discuss about these in the <Link to={'/documentation/styles'}>next section</Link> of the documentation) in <code>scr/assets/jss/material-dashboard-react.jsx</code> and all the rest variables (variables used for example in tasks page etc.) in <code>src/variables/general.jsx</code>.</P>
