  ...
  render() {
    return (
      <div>
        ...
        <P>
          For a better way to call our components we've added a index file in
          the components folder (<code>src/components/index.js</code>) which
          imports all of our restyled components and exports them, so you can
          import any of them easier. Instead of doing something like this
        </P>{" "}
        <SyntaxHighlighter language="jsx" style={prism}>
          {importExample}
        </SyntaxHighlighter>
        ...
        <P>
          ...
          <code>scr/assets/jss/material-dashboard-react.jsx</code> the
        ...
        <P>
          ...
          with the component name and each of them have a comment above for you
          to know where the style will be imported. You will also see that we've
          used some of that styles for <code>src/views/*</code> as well. At the
          beginning of the file you will see some constants that are beeing used
