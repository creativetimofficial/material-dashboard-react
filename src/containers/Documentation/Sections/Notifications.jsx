    ...
    render(){
        return (
            <div>
                ...
                <P>We restyled the classic Material UI Snackbar and gave it a more attractive look.</P>
                <h2>Style</h2>
                <br />
                <SnackbarContent message={'This is a plain notification'} />
                <br />
                ...
                <SnackbarContent message={'PRIMARY - This is a regular notification made with color="primary"'} close color="primary"/>
                <br />
                <SyntaxHighlighter language="jsx" style={prism}>{state}</SyntaxHighlighter>
                <h2>Places</h2>
                <Button fullWidth color="primary" onClick={() => this.showNotification()}>Show random generated position and color notification</Button>
                <Snackbar
                    place={this.state.place}
                    ...
                    close
                />
                <SyntaxHighlighter language="jsx" style={prism}>{place}</SyntaxHighlighter>
                <h2>Props</h2>
                <SyntaxHighlighter language="jsx" style={prism}>{snackbarContent}</SyntaxHighlighter>
                <SyntaxHighlighter language="jsx" style={prism}>{snackbar}</SyntaxHighlighter>
                <P>Beside these props, you can check out the <a href="https://material-ui-next.com/demos/snackbars/" target="_blank" rel="noopener noreferrer">official material-ui documentation</a>.</P>
            </div>
        );
    }
}
