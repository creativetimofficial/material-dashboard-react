                    ...
                    <ul className="dropdown-menu">
                        ...
                        <li className="button-container">
                            <div className="button-container">
                                <Button color="success" href="https://www.creative-tim.com/product/material-dashboard-react" target="_blank" fullWidth>
                                    Download free!
                                </Button>
                            </div>
                        </li>
                        ...
                        <li className="button-container">
                                <GitHubButton type="stargazers"
                                    namespace="creativetimofficial" repo="material-dashboard-react"
                                />
